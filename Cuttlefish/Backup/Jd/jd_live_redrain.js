...
async function retryCdn(code, url) {
    if (code === 'error') {
        ...
        let cndUrl = `https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Jd/jd-live-rain.json`
...
function rraUrl() {
    let url = 'https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Jd/jd-live-rain.json'
