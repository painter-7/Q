...
* @ScriptURL         https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Jd/jd_cash_reward.js
* ==/UserScript==
【QuantumultX】 :
*************************
[task_local]
15 7,15 * * * https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Jd/jd_cash_reward.js, tag=领现金自动获得酬劳
*************************
【Loon】 :
*************************
[Script]
cron "15 7,15 * * *" script-path=https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Jd/jd_cash_reward.js,tag=领现金自动获得酬劳
*************************
【Surge】 :
*************************
[Script]
领现金自动获得酬劳 = type=cron,cronexp="15 7,15 * * *",wake-system=1,timeout=120,script-path=https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Jd/jd_cash_reward.js
*************************
【小火箭】 :
*************************
[Script]
领现金自动获得酬劳 = type=cron,script-path=https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Jd/jd_cash_reward.js, cronexpr="15 7,15 * * *", timeout=500, enable=true
*************************
[mitm]
